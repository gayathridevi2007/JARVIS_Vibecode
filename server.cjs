...
(async () => {
  ...
  const workspaceHandler = await loadHandler('api/workspace.js');
  ...
  app.get('/api/recruiter', (req, res) => workspaceHandler(req, res));
  app.get('/api/admin', (req, res) => workspaceHandler(req, res));
